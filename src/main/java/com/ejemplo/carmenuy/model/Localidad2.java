...
public class Localidad2 {
     ...
     */
    public Localidad2(int id, String nombre, String descripcion, double latitud, double longitud) {
        this.id = id;
        this.nombre = nombre;
     ...
     * @param longitud La longitud de la localidad.
     */
    public Localidad2(String nombre, String descripcion, double latitud, double longitud) {
        this.nombre = nombre;
        this.descripcion = descripcion;
        this.latitud = latitud;
        this.longitud = longitud;
